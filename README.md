...
**Base URL (replace with your own Render deployment once live):**
`https://maternal-risk-api.onrender.com`

**Public Swagger UI:** `https://maternal-risk-api.onrender.com/docs` — *(update this link once you deploy your own instance; Swagger UI is auto-generated by FastAPI at `/docs`)*
...
2. On [Render](https://render.com), create a **New Web Service**, pointing
   at this repo with **Root Directory** = `summative/API`.
3. **Build command:** `pip install -r requirements.txt`
4. **Start command:** `uvicorn prediction:app --host 0.0.0.0 --port 10000`
5. Once deployed, Render gives you a public URL — Swagger UI will be
   available at `<that-url>/docs`. Update this README's API URL and the
   Flutter app's `apiBaseUrl` to match.

## Video Demo

📺 *(add your ≤7-minute YouTube link here once recorded)*
